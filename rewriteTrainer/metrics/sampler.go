...
func ParsePush(r *http.Request) (base.HostInfo, base.StatsWrapper, error) {
	decoder := json.NewDecoder(r.Body)
	var wrapper base.PushWrapper
	err := decoder.Decode(&wrapper)
	if err != nil {
		MetricsLogger.Errorf("StatsWrapper parsing failed - %s", err)
		return base.HostInfo{}, base.StatsWrapper{}, errors.New("Parsing failed")
	}
	return wrapper.HostInfo, wrapper.Stats, nil
}

func RecordStats(host base.HostId, stats base.StatsWrapper, time string) {
